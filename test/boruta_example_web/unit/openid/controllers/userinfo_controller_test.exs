defmodule BorutaExampleWeb.Controllers.Openid.UserinfoControllerTest do
  ...
  alias BorutaExampleWeb.Openid.UserinfoController
  ...
  describe "userinfo/2" do
    ...
    test "returns userinfo response", %{conn: conn} do
      ...
      Boruta.OpenidMock
      |> expect(:userinfo, fn conn, module ->
        module.userinfo_fetched(conn, %UserinfoResponse{userinfo: resource_owner_claims, format: :json})
      end)
