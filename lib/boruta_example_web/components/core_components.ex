defmodule BorutaExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BorutaExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BorutaExampleWeb.Gettext, "errors", msg, opts)
    end
  end
